 ...
 * using a particular flow. Registration is done against a marker class (in this case [ReferralFlow.Initiator]
 ...
 * [ReferralFlow.Acceptor] flow.
 */
object ReferralService {
    class Service(services: PluginServiceHub) {
        init {
            services.registerFlowInitiator(ReferralFlow.Initiator::class) { ReferralFlow.Acceptor(it) }
        }
    }
}
